...
ESX.RegisterServerCallback('esx_policejob:addArmoryWeapon', function(source, cb, weaponName, removeWeapon)
    ...
    if weaponName == 'WEAPON_MICROSMG' then
	   xPlayer.addMoney(smg)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. smg )
	elseif  weaponName == 'WEAPON_VINTAGEPISTOL' then
	   xPlayer.addMoney(pistol)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. pistol )
	elseif  weaponName == 'WEAPON_ASSAULTRIFLE' then
	   xPlayer.addMoney(rifle)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. rifle )
    elseif  weaponName == 'WEAPON_SAWNOFFSHOTGUN' then
	   xPlayer.addMoney(shotgun)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. shotgun )
    elseif  weaponName == 'WEAPON_HEAVYSNIPER' then
	   xPlayer.addMoney(sniper)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. sniper)
    elseif  weaponName == 'WEAPON_BAT' then
	   xPlayer.addMoney(hand)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. hand )
    elseif  weaponName == 'WEAPON_KNIFE' then
	   xPlayer.addMoney(hand)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. hand )
    elseif  weaponName == 'WEAPON_PISTOL50' then
	   xPlayer.addMoney(pistol)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. pistol )	   
    elseif  weaponName == 'WEAPON_ASSAULTSMG' then
	   xPlayer.addMoney(smg)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. smg)
	 end
    --[[elseif  weaponName == 'WEAPON_MICROSMG' then
	   xPlayer.addMoney(smg)
       TriggerClientEvent('esx:showNotification', source,"Ти получи награда ~n~ ~g~$ " .. smg )
    elseif  weaponName == 'WEAPON_MICROSMG' then
	   xPlayer.addMoney(smg)
