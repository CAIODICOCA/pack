...
RegisterServerEvent('esx_mechanicjob:get_kit')
AddEventHandler('esx_mechanicjob:get_kit', function()

local xPlayer = ESX.GetPlayerFromId(source)
local GazBottleQuantity = xPlayer.getInventoryItem('repairkit').count
